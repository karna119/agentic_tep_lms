...
| **Retail** | **Agentic AI Dynamic Price Advisor** | Static pricing reduces competitiveness. | 1. Analyze demand trends.<br>2. Monitor inventory levels.<br>3. Dynamically adjust prices. |
| **Smart Cities** | **Agentic AI Streetlight Scheduler** | Streetlights remain on unnecessarily. | 1. Detect pedestrian/vehicle activity.<br>2. Predict usage patterns.<br>3. Recommend lighting schedules. |
...
| **Disaster Management** | **Agentic AI Emergency Resource Planner** | Emergency resources are allocated inefficiently. | 1. Assess incident severity.<br>2. Prioritize response.<br>3. Recommend deployment of resources. |
| **Finance** | **Agentic AI Credit Risk Assessor** | Credit evaluation is slow. | 1. Analyze bank statement transactions.<br>2. Assess default indicators.<br>3. Generate risk score report. |`,
